...
public class MyJDialog extends JDialog implements ActionListener{
	...
	private void creatHelpDialog() {
		this.setTitle("游戏帮助");
		jtaShow = new JTextArea("单人模式\n"
				+ "1.新手：移动速度较慢，墙壁可穿越；吃到蛇尾则死亡。"
				+"2.普通：移动速度比较慢，墙壁不可穿越，撞到墙或者吃到蛇尾则死亡。\n"
				+ "3.高手：移动速度快，有障碍物，墙壁，不可穿越，撞到墙，障碍物或者吃到蛇尾则死亡。\n\n"
				+ "双人模式\n"
				+ "激斗：初始生命值为10,玩家吃了一颗蛋，另一玩家生命值减少1，生命值为0的玩家败；玩家撞了另一玩家的尾，则该玩家败；" + "两玩家蛇头互撞，则生命值多的玩家胜，生命值相同则同归于尽。\n"
				+ "来呀!相互伤害：60秒倒计时，玩家可以吃另一玩家的尾，以增加的长度;游戏时间结束，蛇长度长的玩家胜；" + "若一玩家只剩蛇头，被吃了蛇头后，该玩家败。\n\n"
				+ "常用快捷键：Esc退出游戏  Space开始/暂停游戏" + "上帝快捷键:加速度 Ctrl+'+' " + "减速度 Ctrl+'-'");
